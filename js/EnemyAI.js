...
class EnemyAI {
    constructor(game) {
        ...
        this.epsteinConfig = {
            1: {
                aiLevel: 14,              // AI等级 (0-20)，12/24 = 50%移动概率
            ...
            3: {
                ...
                soundLureResistance: 0.12  // Night 3开始：15%概率抵抗sound吸引
            },
            4: {
                aiLevel: 20,
    ...
    triggerJumpscare(enemy = 'epstein') {
        ...
        jumpscareImg.style.maxWidth = '80vw';
        ...
        // 第2帧：40% (0.15秒后)
        setTimeout(() => {
            jumpscareImg.style.width = '40%';
        }, 150);
        
        // 第3帧：55% (0.3秒后)
        setTimeout(() => {
            jumpscareImg.style.width = '55%';
        }, 300);
